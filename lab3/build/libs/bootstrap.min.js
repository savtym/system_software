...
/*!
 * Generated using the Bootstrap Customizer (http://getbootstrap.com/customize/?id=f8cea1ada427c87a8ac976d883c200bf)
 * Config saved to config.json and https://gist.github.com/f8cea1ada427c87a8ac976d883c200bf
 */
if ("undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery");+function (t) {
  ...
  function e(e) {
    ...
    if (!this.$tip && (this.$tip = t(this.options.template), 1 != this.$tip.length)) throw new Error(this.type + " `tabs` option must consist of exactly 1 top-level element!");return this.$tip;
